  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid" style="overflow:auto;">
      	<form class="form-horizontal" method="get" action="{{ url('/input_pelanggan') }}" >
           {{ csrf_field() }}
           <fieldset>
            <div class="form-group{{ $errors->has('tgl_awal') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-4">
                            	<label for="penguji" class="col-md-4 control-label">Tanggal Awal</label>
                                <input id="tgl_awal" type="date" class="form-control" name="tgl_awal" value= <?php echo $inputan[0]; ?> required>
             ...
             <div class="form-group{{ $errors->has('tgl_akhir') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-4">
                            	<label for="penguji" class="col-md-4 control-label">Tanggal Akhir</label>
                                <input id="tgl_akhir" type="date" class="form-control" name="tgl_akhir" value= <?php echo $inputan[1]; ?> required>
		...
		<tbody>
			...
			<tr>
				...
				<td>{{$pengujian->hasil_survei}}</td>
				<td>{{$pengujian->status_survei}}</td>
				<td>{{$pengujian->tanggal_survei}}</td>
				<td>{{$pengujian->barcode}}</td>
				<td><a href="../../../belajarandro/Foto/<?php echo $pengujian->foto_survei; ?>" target="_blank">{{$pengujian->foto_survei}}</a></td>
