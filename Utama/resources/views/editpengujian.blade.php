...
<div class="wrapper">
          ...
          <li class="nav-item has-treeview menu-open"> 
           ...
           <li class="nav-item has-treeview menu-close"> 
            <a href="#" class="nav-link">
              <i class="nav-icon fa fa-bar-chart"></i></i><!-- icon-->
              <p>
                Data Proyek
                <i class="right fa fa-angle-left"></i>  
              </p>
  ...
  width:50%;
  padding: 20px;" method="POST" action="{{url('ubah_pengujian'.$pengujian->id_apk)}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('nama_apk') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input placeholder="Nama Pengujian" id="nama_apk" type="text" class="form-control" name="nama_apk" value="{{$pengujian->nama_apk}}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input placeholder="Fungsi Pengujian" id="fungsi_apk" type="text" class="form-control" name="fungsi_apk" value="{{ $pengujian->fungsi_apk }}" required>
                        ...
                        <div class="form-group{{ $errors->has('pemohon') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input placeholder="Pemohon" id="pemohon" type="text" class="form-control" name="pemohon" value="{{ $pengujian->pemohon }}" required>
                        ...
                        <div style="margin-bottom: 15%;" class="form-group{{ $errors->has('jenis') ? ' has-error' : '' }}">
                            <label style="float: left;" for="jenis" class="col-md-4 control-label">Jenis Aplikasi</label>
                        ...
                        <div class="form-group{{ $errors->has('penguji') ? ' has-error' : '' }}">
                            ...
                            <div style="float: left;" class="col-md-8">
								...
								@foreach($list as $data)
	  								...
	  								@if($pengujian->penguji==$data->id)
											selected='selected' @endif><?php echo $data->name; ?></option>
                         ...
                         <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="status" type="hidden" class="form-control" name="status" value="{{ $pengujian->status }}" required>
                                <input id="namaawal" type="hidden" class="form-control" name="namaawal" value="{{ $pengujian->nama_apk }}" required>
                       ...
                       <div style="margin-top: 10%;" class="form-group">
	                        <div class="col-md-8">
		                       <table  border="2">
		                       		<thead>
		                       			<tr>
		                       				<th  style="text-align: center; padding: 5px;">Historis</th>
		                       				<th  style="text-align: center; padding: 5px;">Ubah</th>
		                       			</tr>
		                       		</thead>
		                       		<tbody>
		                       			<?php $a=0;?>
		                       			@foreach($buffer as $evi)
		                       				
		                       			<tr>
		                       				<td style="padding: 5px;"><?php echo $buffer[$a]; 
		                       					$pdf="pdf".$a;
												$a=$a+1;
		                       					?></td>
		                       				<td ><input type="file" name=<?php echo $pdf; ?>  /></td>
