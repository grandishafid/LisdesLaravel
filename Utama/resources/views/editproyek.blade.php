    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview"> <!-- untuk buka tutup menu-->
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
      		 ...
      		 <form class="form-horizontal" method="POST" action="{{url('ubah_proyek'.$pengujian->id_proyek)}}">
                        {{ csrf_field() }}

                        <div class="form-group{{ $errors->has('nama_proyek') ? ' has-error' : '' }}">
                            <label for="nama_proyek" class="col-md-4 control-label">Nama Proyek</label>

                            <div class="col-md-6">
                                <input id="nama_proyek" type="text" class="form-control" name="nama_proyek" value="{{$pengujian->nama_proyek}}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('rencana_anggaran') ? ' has-error' : '' }}">
                            <label for="rencana_anggaran" class="col-md-4 control-label">Rencana Anggaran</label>

                            <div class="col-md-6">
                                <input id="rencana_anggaran" type="text" class="form-control" name="rencana_anggaran" value="{{$pengujian->rencana_anggaran}}" required>

                                @if ($errors->has('rencana_anggaran'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('rencana_anggaran') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('jenis_anggaran') ? ' has-error' : '' }}">
                            <label for="jenis_anggaran" class="col-md-4 control-label">Jenis Anggaran</label>

                            <div class="col-md-6">
                                <select name="jenis_anggaran" class="form-control">
									
	  								<option value="1" @if($pengujian->jenis_anggaran=='1')
											selected='selected' @endif>
											
											Anggaran Investasi</option>
											
	  								<option value="2" @if($pengujian->jenis_anggaran=='2')
											selected='selected' @endif>
											
											Anggaran Operasional</option>
	  								
	  								
								
 								 </select>

                                @if ($errors->has('jenis_anggaran'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('jenis_anggaran') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('tahun_imple') ? ' has-error' : '' }}">
                            <label for="tahun_imple" class="col-md-4 control-label">Tahun Implementasi</label>

                            <div class="col-md-6">
                                <input id="tahun_imple" type="text" class="form-control" name="tahun_imple" value="{{$pengujian->tahun_imple}}" required>

                                @if ($errors->has('tahun_imple'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('tahun_imple') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('tanggal_kontrak') ? ' has-error' : '' }}">
                            <label for="tanggal_kontrak" class="col-md-4 control-label">Tanggal Kontrak</label>

                            <div class="col-md-6">
                                <input id="tanggal_kontrak" type="date" class="form-control" name="tanggal_kontrak" value="{{$pengujian->tanggal_kontrak}}" required>

                                @if ($errors->has('tanggal_kontrak'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('tanggal_kontrak') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        
                        <div class="form-group{{ $errors->has('realisasi_biaya') ? ' has-error' : '' }}">
                            <label for="realisasi_biaya" class="col-md-4 control-label">Realisasi Biaya</label>

                            <div class="col-md-6">
                                <input id="realisasi_biaya" type="text" class="form-control" name="realisasi_biaya" value="{{$pengujian->realisasi_biaya}}" required>

                                @if ($errors->has('realisasi_biaya'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('realisasi_biaya') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('vendor_pelaksana') ? ' has-error' : '' }}">
                            <label for="vendor_pelaksana" class="col-md-4 control-label">Vendor Pelaksana</label>

                            <div class="col-md-6">
                                <input id="vendor_pelaksana" type="text" class="form-control" name="vendor_pelaksana" value="{{$pengujian->vendor_pelaksana}}" required>

                                @if ($errors->has('vendor_pelaksana'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('vendor_pelaksana') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                          ...
                          <div class="form-group{{ $errors->has('target_selesai') ? ' has-error' : '' }}">
                            <label for="target_selesai" class="col-md-4 control-label">Target Selesai</label>

                            <div class="col-md-6">
                                <input id="target_selesai" type="date" class="form-control" name="target_selesai" value="{{$pengujian->target_selesai}}" required>

                                @if ($errors->has('target_selesai'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('target_selesai') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('pic_pln') ? ' has-error' : '' }}">
                            <label for="pic_pln" class="col-md-4 control-label">PIC</label>

                            <div class="col-md-6">
                                <input id="pic_pln" type="text" class="form-control" name="pic_pln" value="{{$pengujian->pic_pln}}" required>

                                @if ($errors->has('pic_pln'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('pic_pln') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                         ...
                         <div class="form-group{{ $errors->has('status_proyek') ? ' has-error' : '' }}">
                            <label for="status_proyek" class="col-md-4 control-label">Status Proyek</label>

                            <div class="col-md-6">
                                <select name="status_proyek" class="form-control">
									
	  								<option value="1" @if($pengujian->status_proyek=='1')
											selected='selected' @endif>
											
											Dalam Perencanaan</option>
											
	  								<option value="2" @if($pengujian->status_proyek=='2')
											selected='selected' @endif>
											
											Sedang Berjalan</option>
	  								
	  								<option value="3" @if($pengujian->status_proyek=='3')
											selected='selected' @endif>
